    ...
    buildSection(
      ...
      [
        ...
        keywordRows.length
          ...
          : `No direct keyword rows were returned for this exact query. This draft uses the seed term "${seedKeyword}" as the primary target and should be refined with a broader or adjacent seed phrase.`
      ],
